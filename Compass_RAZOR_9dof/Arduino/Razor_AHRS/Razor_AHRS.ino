...
const float magn_ellipsoid_center[3] = {165.667, 65.8807, 55.7427};
const float magn_ellipsoid_transform[3][3] = {{0.936719, -0.0169881, -0.00405576}, {-0.0169881, 0.995077, 0.00482380}, {-0.00405576, 0.00482380, 0.903357}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -45)
#define GYRO_AVERAGE_OFFSET_Y ((float) 44)
#define GYRO_AVERAGE_OFFSET_Z ((float) -18)
